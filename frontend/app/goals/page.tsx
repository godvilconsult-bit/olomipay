...
import { ArrowLeft, Plus, X, Target, Sparkles, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen pb-24">
      <div className="sticky top-0 z-40 bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 px-5 py-4 flex items-center gap-3">
        ...
        <button onClick={() => setShowNew(true)} className="ml-auto flex items-center gap-1 text-sm font-semibold text-primary">
          <Plus size={18} /> New
        </button>
      </div>
