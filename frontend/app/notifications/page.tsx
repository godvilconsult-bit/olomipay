...
export default function NotificationsPage() {
  ...
  return (
    <div className="min-h-screen pb-24">
      <PageHeader eyebrow="Account" title="Notifications" right={
        notifications.some(n => !n.isRead) ? (
          <button onClick={markAllRead} className="text-xs text-primary font-semibold flex items-center gap-1 px-1">
