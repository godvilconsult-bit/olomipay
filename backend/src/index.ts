...
async function loadRoutes() {
  const mounts: [string, () => Promise<any>, string][] = [
    ...
    ['/api/rfq',       () => import('./routes/rfq'),       'rfqRouter'],
    ...
    ['/api/cylinders', () => import('./routes/cylinders'), 'cylindersRouter'],
    ...
    ['/api/chat',      () => import('./routes/chat'),      'chatRouter'],
    ['/api/support',   () => import('./routes/support'),   'supportRouter'],
